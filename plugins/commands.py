...
async def start(client, message):
    if len(message.command) > 1:
        if message.command[1] == 'help':
            ...
            await message.reply("Learn to use the VidCall, Showing help menu, Choose from the below options.",
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Poocongonlen'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/poocong/VidCall')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/poocong/VidCall'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Poocongonlen'),     
        ],
        [
